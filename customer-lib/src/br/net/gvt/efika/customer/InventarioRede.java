...
public class InventarioRede {
    ...
    private Integer slot, porta, sequencial, logica, rin, vlanVoip, vlanVod, vlanMulticast, cvLan, vlanUsuario;
    ...
    public Integer getVlanUsuario() {
        return vlanUsuario;
    }

    public void setVlanUsuario(Integer vlanUsuario) {
